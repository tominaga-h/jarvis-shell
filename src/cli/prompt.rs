...
fn current_git_branch_at(cwd: &Path) -> Option<String> {
...
fn format_git_status_at(cwd: &Path, nerd_font: bool) -> String {
...
fn format_branch_label(branch: &str, nerd_font: bool) -> String {
    if nerd_font {
