#!/bin/zsh
# Vendored from https://github.com/Valodim/zsh-capture-completion (capture.zsh)
# License: MIT — Copyright (c) Vincent Breitmoser and contributors
# Upstream sha256 as fetched on 2026-07-10:
#   5aa248ae7e0bf5d1e86ee2004fbe82c5215bfbe371c99bf8cd81069b9dab62d4
# Local jarvish modifications (if any) are marked with "# jarvish:" comments.
